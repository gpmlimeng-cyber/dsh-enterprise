...
export const listPresetPackages = <ThrowOnError extends boolean = false>(options?: Options<ListPresetPackagesData, ThrowOnError>): RequestResult<ListPresetPackagesResponses, ListPresetPackagesErrors, ThrowOnError> => (options?.client ?? client).get<ListPresetPackagesResponses, ListPresetPackagesErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
...
export const uploadPresetVersion = <ThrowOnError extends boolean = false>(options: Options<UploadPresetVersionData, ThrowOnError>): RequestResult<UploadPresetVersionResponses, UploadPresetVersionErrors, ThrowOnError> => (options.client ?? client).post<UploadPresetVersionResponses, UploadPresetVersionErrors, ThrowOnError>({
...
export const publishPresetVersion = <ThrowOnError extends boolean = false>(options: Options<PublishPresetVersionData, ThrowOnError>): RequestResult<PublishPresetVersionResponses, PublishPresetVersionErrors, ThrowOnError> => (options.client ?? client).post<PublishPresetVersionResponses, PublishPresetVersionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
...
export const retirePresetVersion = <ThrowOnError extends boolean = false>(options: Options<RetirePresetVersionData, ThrowOnError>): RequestResult<RetirePresetVersionResponses, RetirePresetVersionErrors, ThrowOnError> => (options.client ?? client).post<RetirePresetVersionResponses, RetirePresetVersionErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
...
export const replacePresetAssignments = <ThrowOnError extends boolean = false>(options: Options<ReplacePresetAssignmentsData, ThrowOnError>): RequestResult<ReplacePresetAssignmentsResponses, ReplacePresetAssignmentsErrors, ThrowOnError> => (options.client ?? client).post<ReplacePresetAssignmentsResponses, ReplacePresetAssignmentsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
...
export const listRuntimePresets = <ThrowOnError extends boolean = false>(options?: Options<ListRuntimePresetsData, ThrowOnError>): RequestResult<ListRuntimePresetsResponses, ListRuntimePresetsErrors, ThrowOnError> => (options?.client ?? client).get<ListRuntimePresetsResponses, ListRuntimePresetsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
...
export const getRuntimePreset = <ThrowOnError extends boolean = false>(options: Options<GetRuntimePresetData, ThrowOnError>): RequestResult<GetRuntimePresetResponses, GetRuntimePresetErrors, ThrowOnError> => (options.client ?? client).get<GetRuntimePresetResponses, GetRuntimePresetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
...
export const downloadRuntimePreset = <ThrowOnError extends boolean = false>(options: Options<DownloadRuntimePresetData, ThrowOnError>): RequestResult<DownloadRuntimePresetResponses, DownloadRuntimePresetErrors, ThrowOnError> => (options.client ?? client).get<DownloadRuntimePresetResponses, DownloadRuntimePresetErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
