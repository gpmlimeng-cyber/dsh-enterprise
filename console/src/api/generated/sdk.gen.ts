...
export const getUsageAnalytics = <ThrowOnError extends boolean = false>(options: Options<GetUsageAnalyticsData, ThrowOnError>): RequestResult<GetUsageAnalyticsResponses, GetUsageAnalyticsErrors, ThrowOnError> => (options.client ?? client).get<GetUsageAnalyticsResponses, GetUsageAnalyticsErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }, {
            in: 'cookie',
            name: 'enterprise-admin',
            type: 'apiKey'
