 ...
 * [OUTPUT]: 对外提供 UseThisHarness 站点级装配组件及其公开类型。
...
2. Install the deps it uses: tailwindcss v4 and lucide-react for the sidebar
   icons. Dev dial tuning (dialkit) is optional; drop it if you don't need it.
