...
cordis.patch.yml: 官方 profile layer，覆盖企业 default 并插入企业 Host/Client row；保留官方 llm-deepseek/llm-pi-ai/ui-settings-models 以恢复个人自定义模型能力，企业模型经隔离 settings 实例挂载。
