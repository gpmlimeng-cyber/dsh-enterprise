...
desktop-2.0.3-harness-rc2-migration.md: 历史 Desktop 2.0.3 迁移证据；当前插件基线已改为官方 Harness Desktop 0.1.7-rc.1，本文不再是发行真源。
desktop-client.md: 员工桌面客户端与插件基线说明，锁定官方 Harness Desktop 0.1.7-rc.1，并记录企业打包层、本地安装和旧映射版本的边界。
