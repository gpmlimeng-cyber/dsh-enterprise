...
> 🔒 供应商 API Key 不会下发到你的设备。每次模型请求都由 DSH Enterprise 网关重新校验身份、授权与额度。
...
管理员发布并对你可见的插件，在**操作路径**：DSH Enterprise 设置 → 插件 里可以搜索、查看详情、**自主安装、更新和卸载**。
...
- 上一篇：《使用 DSH Enterprise Desktop（无需 Node/pnpm）》
