package com.owndsh.common.redis.config;

import cn.hutool.core.util.ObjectUtil;
import com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.fasterxml.jackson.annotation.PropertyAccessor;
import lombok.extern.slf4j.Slf4j;
import com.owndsh.common.redis.config.properties.RedissonProperties;
import com.owndsh.common.redis.handler.KeyPrefixHandler;
import com.owndsh.common.redis.handler.RedisExceptionHandler;
    ...
    public RedissonAutoConfigurationCustomizer redissonCustomizer() {
        return config -> {
            ...
            JsonMapper jsonMapper = JsonMapper.builder()
                ...
                // 一般而言，更加建议使用包名白名单的方式去进行匹配，以确保放行通过安全认可的类，如：BasicPolymorphicTypeValidator.builder().allowIfBaseType("com.owndsh").allowIfSubType("com.owndsh").build()
