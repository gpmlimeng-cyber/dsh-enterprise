package com.owndsh.common.oss.client;

import cn.hutool.core.lang.Assert;
import cn.hutool.core.util.IdUtil;
import com.owndsh.common.core.utils.DateUtils;
import com.owndsh.common.core.utils.StringUtils;
import com.owndsh.common.oss.config.OssClientConfig;
import com.owndsh.common.oss.exception.S3StorageException;
import com.owndsh.common.oss.io.OutputStreamDownloadSubscriber;
import com.owndsh.common.oss.model.GetObjectResult;
import com.owndsh.common.oss.model.HandleAsyncResult;
...
public abstract class AbstractOssClientImpl implements OssClient {
    ...
    public PutObjectResult bucketUpload(String bucket, String key, InputStream in, long contentLength, Options options) {
        Path tempFile = null;
        try {
            tempFile = Files.createTempFile("owndsh-oss-upload-", ".tmp");
