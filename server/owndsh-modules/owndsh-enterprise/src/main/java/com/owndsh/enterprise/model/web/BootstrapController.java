/**
 * [INPUT]: 依赖 BootstrapService、EnterpriseSessionProperties、EnterpriseCollabProperties 与 DeviceRequestContextResolver 的可信 dsh-desktop 会话上下文。
 * [OUTPUT]: 提供 GET /enterprise/api/v1/bootstrap 脱敏快照，sessionPolicy/collabPolicy 与部署配置一致。
...
public final class BootstrapController {
    ...
    private final EnterpriseCollabProperties collabProperties;
    ...
    public EnterpriseResponse<BootstrapView> get(HttpServletRequest request) {
        ...
        return new EnterpriseResponse<>(
            BootstrapView.from(bootstrap.load(context), sessionProperties, collabProperties),
            context.requestId()
        );
    }
}
